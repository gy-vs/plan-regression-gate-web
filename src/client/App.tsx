...
export default function App(){
  ...
  useEffect(()=>{setStatus('Loading');fetch('/api/plans/'+selected).then(r=>r.json()).then((value:Row)=>{setRow(value);setDraft(value.content);setStatus('Loaded')})},[selected]);
